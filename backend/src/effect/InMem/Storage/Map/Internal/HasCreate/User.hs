...
--
-- @since 0.2.0.0
module InMem.Storage.Map.Internal.HasCreate.User where
...
-- Left "Error in $: parsing InMem.Storage.Map.Internal.HasCreate.User.CreateOf(UserCreate) failed, key \"password\" not found"
