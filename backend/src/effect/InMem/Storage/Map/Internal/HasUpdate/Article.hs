...
--
-- @since 0.2.0.0
module InMem.Storage.Map.Internal.HasUpdate.Article where
...
import Relude.Extra ((.~))
import InMem.Storage.Map.Internal.HasStorage (ContentOf)
import InMem.Storage.Map.Internal.HasStorage.Article ()
import InMem.Storage.Map.Internal.HasUpdate (HasUpdate (UpdateOf), Patch, updatableKeys)
