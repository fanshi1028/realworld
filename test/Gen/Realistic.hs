...
instance Arbitrary (Realistic Username) where
  ...
  shrink (Realistic (Username u)) = Realistic . Username <$> shrink u
...
instance Arbitrary (Realistic Bio) where
  ...
  shrink (Realistic (Bio b)) = Realistic . Bio <$> shrink b
...
instance Arbitrary (Realistic Title) where
  ...
  shrink (Realistic (Title tt)) = Realistic . Title <$> shrink tt
...
instance Arbitrary (Realistic Description) where
  ...
  shrink (Realistic (Description d)) = Realistic . Description <$> shrink d
...
instance Arbitrary (Realistic Body) where
  ...
  shrink (Realistic (Body b)) = Realistic . Body <$> shrink b
