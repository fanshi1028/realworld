  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "hasql-transaction".revision = (((hackage."hasql-transaction")."1.0.1").revisions).default;
        ...
        "binary-parser".revision = (((hackage."binary-parser")."0.5.7").revisions).default;
        ...
        "fakedata".revision = (((hackage."fakedata")."1.0.1").revisions).default;
